...
const Beauty_Flawless_Skin = () => {
  return (
    <>
      <div className="wrapper  flex   mt-52 border-b-2 mb-5 pb-20" >
     
          <img src={Beauty_Flawless_Skin_img} className="h-[44rem]" />
       
        <div className="p-32  " >
          <h1 className="mb-6">━━━━</h1>
          <p className="text-[2.5rem] mb-8 font-extralight ">Beauty Flawless Skin</p>
